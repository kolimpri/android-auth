    ...
    public void startUpdatesButtonHandler(View view)
    {
        if (!mRequestingLocationUpdates) {
            ...
            if(mGoogleApiClient.isConnected()){
                ...
                String errorMsg = "GoogleApi Client is not connected yet.";
                Toast.makeText(getApplicationContext(), errorMsg, Toast.LENGTH_LONG).show();
            }
            /*try {
                startLocationUpdates();
            }catch(Exception e){
                //Getting Error Message from Exception. [Enhancement: GoogleApi Client]
    ...
    public void storeLocation(){
        ...
        StringRequest strReq = new StringRequest(Method.POST,
            ...
            public void onResponse(String response) {
                Log.d(TAG, "Location storage response: " + response.toString());
                hideDialog();
                ...
                try {
                    ...
                    if (!error) {
                        //Here is the code for success locations storage
                    } else {
            ...
            public void onErrorResponse(VolleyError error) {
                Log.e(TAG, "Location storage error: " + error.getMessage());
                Toast.makeText(getApplicationContext(),
